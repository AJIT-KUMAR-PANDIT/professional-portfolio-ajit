    ...
    <main className="min-h-screen overflow-hidden">
      <header className="site-header">
        ...
        <nav className={menuOpen ? 'nav-links is-open' : 'nav-links'} aria-label="Main navigation">
          {['About', 'Skills', 'Projects', 'Contact'].map((item) => <a key={item} href={`#${item.toLowerCase()}`} onClick={closeMenu}>{item}</a>)}
        </nav>
      </header>
      ...
      <section id="top" className="hero section-shell">
        ...
        <div className="social-row"><a href="https://github.com/ajit-kumar-pandit" target="_blank" rel="noreferrer"><Code2 size={17} /> GitHub</a><a href="#experience"><BriefcaseBusiness size={17} /> Experience</a><a href="mailto:ajit@nakprc.com"><Mail size={17} /> Email</a></div>
      </section>
