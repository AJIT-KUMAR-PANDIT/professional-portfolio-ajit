...
const skillGroups = [
  ...
  { label: 'Cloud & DevOps', skills: ['AWS · EC2', 'MinIO · Open Source S3', 'Docker', 'CI/CD Pipelines', 'Linux', 'Cloudflare', 'Vercel'] },
  { label: 'AI / ML', skills: ['Deep Learning', 'Neural Networks', 'TensorFlow / PyTorch', 'Computer Vision', 'AI Integration'] },
]

const projects = [
  { number: '01', title: 'Scalable digital products', description: 'Full-stack web applications that move from a thoughtful interface to reliable, production-ready systems.', tags: ['MERN', 'Next.js', 'Cloud'] },
  { number: '02', title: 'AI-powered experiences', description: 'Practical AI integrations, neural network experiments, and intelligent workflows built around real problems.', tags: ['AI / ML', 'Python', 'APIs'] },
  { number: '03', title: 'Engineering for scale', description: 'Clean architecture, cloud infrastructure, and performance-minded APIs for teams that need to grow with confidence.', tags: ['AWS', 'Docker', 'Systems'] },
]
  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <section id="top" className="hero section-shell">
        ...
        <div className="role-line"><span /> Full Stack MERN Developer</div>
        <p className="hero-copy">Crafting innovative, user-friendly web applications and AI-powered solutions at the intersection of scalable architecture and creative engineering.</p>
        ...
        <div className="social-row"><a href="https://github.com/ajitkumarpandit" target="_blank" rel="noreferrer"><Code2 size={17} /> GitHub</a><a href="#experience"><BriefcaseBusiness size={17} /> Experience</a><a href="mailto:ajit@nakprc.com"><Mail size={17} /> Email</a></div>
      ...
      <section id="about" className="section-shell content-section about-section">
        ...
        <div className="about-grid"><div><h2>Engineering clarity<br /><span>into complexity.</span></h2></div><div className="about-text"><p>I&apos;m a passionate Full Stack Developer based in <strong>Jamshedpur, Jharkhand, India</strong>, with a deep love for crafting innovative and user-friendly web applications.</p><p>My journey spans scalable web architectures, cloud infrastructure, and AI-powered solutions for industry leaders like Tata Steel and Samsung R&amp;D Institute.</p><p className="quote">Build over hype.<br />Quality over quantity.</p></div></div>
        <div className="stats"><div><strong>44<span>+</span></strong><small>PUBLIC REPOSITORIES</small></div><div><strong>21<span>+</span></strong><small>TECHNICAL ARTICLES</small></div><div><strong>3<span>+</span></strong><small>YEARS EXPERIENCE</small></div></div>
      </section>
      ...
      <section id="experience" className="section-shell content-section"><div className="section-label">03 / Experience</div><div className="experience-row"><div><p className="date-range">3+ YEARS EXPERIENCE · 2023 — PRESENT</p><h2>Full Stack<br /><span>Developer</span></h2></div><div className="experience-detail"><div className="experience-company">Independent / Product Engineering <span>India</span></div><p>Building complete digital products from first sketch to shipped system. Focused on maintainable code, thoughtful interfaces, and solving the problem behind the brief.</p><div className="pill-row"><span>MERN Stack</span><span>Cloud Architecture</span><span>AI Integration</span></div></div></div><div className="experience-row secondary"><div><p className="date-range">2020 — 2023</p><h2>B.E.<br /><span>Computer Science</span></h2></div><div className="experience-detail"><div className="experience-company">Chandigarh University <span>CU</span></div><p>Computer science foundation shaped by hands-on building, curiosity, and a drive to understand how systems work end-to-end.</p></div></div></section>
      ...
      <section id="education" className="section-shell content-section education-section"><div className="section-label">05 / Education</div><div className="education-grid"><div><h2>Always<br /><span>learning.</span></h2></div><div className="education-list"><div><b>M.Tech · Computer Science &amp; Engineering</b><span>Advanced systems, AI, and software engineering · 2024—2026</span></div><div><b>B.E. Computer Science</b><span>Chandigarh University [ CU ] · 2020—2023</span></div><div><b>Diploma · Computer Engineering</b><span>Nettur Technical Training Foundation [ NTTF ] · 2017—2020</span></div><div><b>Fullstack Web Development Certification</b><span>Cuvette · 2023—2024</span></div></div></div></section>
