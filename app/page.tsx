  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <section id="about" className="section-shell content-section about-section">
        ...
        <div className="stats"><div><strong>44<span>+</span></strong><small>PUBLIC REPOSITORIES</small></div><div><strong>21<span>+</span></strong><small>TECHNICAL ARTICLES</small></div><div><strong>3<span>+</span></strong><small>GITHUB PROJECTS</small></div></div>
      </section>
      ...
      <section id="experience" className="section-shell content-section"><div className="section-label">03 / Education &amp; Experience</div><div className="experience-row"><div><p className="date-range">2024 — PRESENT</p><h2>M.Tech<br /><span>Computer Science &amp; Engineering</span></h2></div><div className="experience-detail"><div className="experience-company">Arka Jain University <span>AJU</span></div><p>Advanced studies in AI, machine learning, and software engineering — focusing on intelligent systems and LLM-powered applications.</p></div></div></section>
      ...
      <section id="education" className="section-shell content-section education-section"><div className="section-label">05 / Education</div><div className="education-grid"><div><h2>Always<br /><span>learning.</span></h2></div><div className="education-list"><div><b>M.Tech · Computer Science &amp; Engineering</b><span>Arka Jain University · Advanced AI, ML &amp; Software Engineering · 2024—2026</span></div><div><b>B.E. Computer Science</b><span>Chandigarh University [ CU ] · 2020—2023</span></div><div><b>Diploma · Computer Engineering</b><span>Nettur Technical Training Foundation [ NTTF ] · 2017—2020</span></div><div><b>Fullstack Web Development Certification</b><span>Cuvette · 2023—2024</span></div></div></div></section>
