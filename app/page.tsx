...
export default function Page() {
  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <section id="experience" className="section-shell content-section"><div className="section-label">03 / Education &amp; Experience</div><div className="experience-row"><div><p className="date-range">2024 — PRESENT</p><h2>M.Tech<br /><span>Computer Science &amp; Engineering</span></h2></div><div className="experience-detail"><div className="experience-company">Arka Jain University <span>AJU</span></div></div></div><div className="experience-row secondary"><div><p className="date-range">AUG — OCT 2025</p><h2>Machine Learning<br /><span>Internship</span></h2></div><div className="experience-detail"><div className="experience-company">Tata Steel Remote <span>Tata</span></div><p>Applied Deep Learning and Neural Networks to real-world image analysis problems in an industrial setting.</p></div></div><div className="experience-row secondary"><div><p className="date-range">SEP 2021 — MAY 2022</p><h2>Research<br /><span>Internship</span></h2></div><div className="experience-detail"><div className="experience-company">Samsung R&amp;D Institute India / Samsung PRISM Remote <span>Samsung</span></div><p>Contributed to research and development in advanced technologies through Samsung's remote internship program.</p></div></div></section>
